...
public class S2_PlayerCollisionController : MonoBehaviour {
    ...
    private void OnTriggerEnter(Collider collision)
    {
        if((playerStatus[0] && playerStatus[1] && !playerStatus[2]))
        {
            ...
            if (collision.gameObject.layer == 10 || collision.gameObject.layer == 11 || collision.gameObject.layer == 12) { S2_HUDUI.Instance.SetScore(collision.gameObject.layer - 9); print("safe zone"); }
